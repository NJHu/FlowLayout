...
- (void)viewDidLoad {
    ...
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 600) collectionViewLayout:lineFlowLayout];
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    if([self.collectionView.collectionViewLayout isKindOfClass:[LMJCircleLayout class]])
    {
//        LMJLineFlowLayout *line = [[LMJLineFlowLayout alloc] init];
